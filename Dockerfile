...
RUN export TZ=Europe/Rome && \
	...
	apt-get -y install --no-install-recommends fonts-takao libqt5core5a qtscript5-dev libc6 libgcc1 libstdc++6 libqt5network5 rsync cron ssh ssh-askpass sendemail jq libnet-ssleay-perl libio-socket-ssl-perl && \
